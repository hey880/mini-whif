...
### 7. 기능 검증 테스트 실행 (로컬 환경)

> 💡 **참고**: 로컬 환경에서는 **기능 검증** 목적입니다 (5-15 VUs).
> 실제 부하 테스트는 스테이징 환경 구축 후 진행하세요.

```bash
# SSE 스트리밍 기능 검증 (13분, 15 VUs)
pnpm load:chat

# ConnectRPC 기능 검증 (13분, 5 VUs)
pnpm load:rpc

# 혼합 워크로드 검증 (20분, 15 VUs)
pnpm load:mixed
```
